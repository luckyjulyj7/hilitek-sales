  ...
  return (
    <footer className="mt-16 bg-ink text-white/70 font-sans">
      <div className="mx-auto max-w-[1500px] px-4 py-12 grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1.2fr_1.4fr]">
        ...
        <div>
          <h4 className="font-display text-[14px] font-semibold uppercase tracking-wide text-white mb-3">Danh mục</h4>
        ...
        <div>
          <h4 className="font-display text-[14px] font-semibold uppercase tracking-wide text-white mb-3">Liên hệ</h4>
          <ul className="space-y-2 text-[14px]">
