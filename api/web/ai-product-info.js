...
4. "seoTitle": Thẻ tiêu đề SEO — ĐẶT từ khoá chính lên ĐẦU câu (Google ưu tiên từ khoá ở đầu title), LUÔN kết thúc bằng hậu tố cố định " | HiliPC" (nhận diện thương hiệu). Vì hậu tố này chiếm sẵn 10 ký tự, phần tên/mô tả sản phẩm phía trước phải viết NGẮN GỌN, chỉ khoảng 40-48 ký tự, để CẢ CÂU (kể cả " | HiliPC") không vượt quá 60 ký tự — quá 60 ký tự sẽ bị Google cắt cụt giữa chừng trên kết quả tìm kiếm, rất xấu. KHÔNG nhét thêm "chính hãng" hay điểm nổi bật khác vào tiêu đề nữa (để dồn hết chỗ đó cho mô tả SEO bên dưới) — tiêu đề chỉ gồm: <từ khoá chính, rút gọn> | HiliPC.
5. "seoDesc": Thẻ mô tả SEO (meta description) — mục tiêu là câu khiến người thấy trên Google MUỐN bấm vào. Chứa từ khoá chính GẦN ĐẦU câu, kèm 1 điểm bán hàng cụ thể (thông số nổi bật/ưu đãi/tình trạng hàng) + nhắc "chính hãng" (điểm này KHÔNG còn nằm trong tiêu đề nữa) + lời kêu gọi hành động ngắn (VD "mua ngay tại Hilitek", "chính hãng, bảo hành đầy đủ"). Giới hạn NGHIÊM NGẶT 140-155 ký tự (kể cả khoảng trắng) — đây là ngưỡng Google thường hiển thị đủ không bị cắt, không viết dài hơn. KHÔNG dùng chung 1 công thức/câu chữ y hệt cho mọi sản phẩm — mỗi sản phẩm phải có mô tả SEO riêng biệt, cụ thể theo đúng sản phẩm đó.
